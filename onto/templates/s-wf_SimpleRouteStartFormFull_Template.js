...
export const html = `
  <div>
    <div class="row row-attribute -view edit -search" id="tooltip">
      ...
      <div class="col-sm-9 col-xs-7">
        <div class="alert alert-info" style="padding:10px;">
          <div about="@" property="s-wf:SimpleRouteStartForm_tooltip" style="white-space: pre-line; line-height: 1;"></div>
        </div>
      </div>
    </div>
    ...
    <div class="row row-attribute">
      <div class="col-sm-3 col-xs-5">
        <label about="s-wf:SimpleRouteStartForm_controller" property="rdfs:label"></label>
      </div>
      <div class="col-sm-9 col-xs-7">
