...
export const pre = function (individual, template, container, mode, extra) {
  ...
  return individual.getPropertyChain("v-wf:onWorkOrder", "v-wf:forWorkItem", "v-wf:forNetElement").then(function(forNetElementArr) {
    //is rework task
    if (forNetElementArr.length > 0 && forNetElementArr[0].id === "s-wf:cr_rework") {
      return individual.getPropertyChain("v-wf:onWorkOrder", "v-wf:forWorkItem", "v-wf:forProcess").then(function(forProcessArr) {
    ...
    <div class="row">
      <div class="col-sm-7 col-md-9" style="border-right: 1px dotted #ccc;">
        ...
        <div class="possible-decisions clearfix" style="position:relative">
          ...
          <div class="margin-sm">
            <button type="button" class="btn btn-default view -edit -search" id="decisionRedirect" about="v-wf:DecisionDelegate_Bundle" property="rdfs:label"></button>
            <button type="button" class="btn btn-primary view -edit -search" id="edit-StartForm" about="s-wf:UserTaskForm_StartForm_Bundle" property="rdfs:label"></button>
