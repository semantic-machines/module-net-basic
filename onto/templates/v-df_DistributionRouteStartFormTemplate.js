...
export const html = `
  <div class="container sheet">
    <h3>
      <span about="v-df:DistributionRouteStartForm" property="rdfs:label"></span><br />
  ...
  <div about="@" rel="v-wf:processedDocument" data-template="v-ui:ClassNameLabelLinkTemplate" class="view edit search"></div-->
    <div class="row">
      <div class="col-md-6">
        ...
        <veda-control rel="v-s:responsible" data-type="link" class="-view edit search fulltext list tree"></veda-control>
      </div>
      <div class="col-md-4">
    ...
    <div class="checkbox -edit" id="set-canEdit">
      <label>
